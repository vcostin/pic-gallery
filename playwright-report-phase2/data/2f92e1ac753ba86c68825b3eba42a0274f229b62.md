...
- Name: Authentication UI Elements >> should display login form
- Location: /Users/vcostin/Work/pic-gallery/e2e-tests/auth.spec.ts:106:7
...
Call log:
  - navigating to "http://localhost:3000/auth/login", waiting until "load"
    ...
    at /Users/vcostin/Work/pic-gallery/e2e-tests/auth.spec.ts:107:16
```
